                              ...
                              po::positional_options_description &p)
{
    ...
    mainOptions.add_options()
            ...
            ("periodic,p", "particle data is in a periodic box with box coordinates given by option '--box'.")
            ;
...
void User_options::readOptions(int argc, char *argv[], bool getFileNames, bool showOptions)
{
    ...
    if ( not (vm.count("help") or vm.count("full_help")) and not (vm.count("inputFile") and vm.count("outputFile")) and getFileNames )
        exit( EXIT_SUCCESS );
